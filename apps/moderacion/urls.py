...
urlpatterns = [
    ...
    path('oferta/<int:pk>/detalle/', views.detalle_oferta, name='mod_detalle_oferta'),
    ...
    path('categorias/<int:categoria_id>/habilidades/', views.listar_habilidades, name='mod_listar_habilidades'),
    path('categorias/<int:categoria_id>/habilidades/crear/', views.crear_habilidad, name='mod_crear_habilidad'),
